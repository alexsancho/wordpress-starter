...
?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="featured-post">
			<?php _e( 'Featured post', 'foundation' ); ?>
		</div>
		<?php endif; ?>
			...
			<?php if ( is_singular() && get_the_author_meta( 'description' ) && is_multi_author() ):
				...
				<div class="author-info clearfix">
					<div class="author-avatar">
						<?php echo get_avatar( get_the_author_meta( 'user_email' ), apply_filters( 'foundation_author_bio_avatar_size', 68 ) ); ?>
					</div>
					<div class="author-description">
						...
						<div class="author-link">
							<a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" rel="author">
								<?php printf( __( 'View all posts by %s <span class="meta-nav">&rarr;</span>', 'foundation' ), get_the_author() ); ?>
							</a>
						</div>
					</div>
				</div>
