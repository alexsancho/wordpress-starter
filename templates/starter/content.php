	...
	<footer class="entry-meta">
		<?php if ( 'post' == get_post_type() ) : // Hide category and tag text for pages on Search ?>
			...
			<span class="cat-links">
				<?php printf( __( 'Posted in %1$s', 'starter' ), $categories_list ); ?>
			</span>
			...
			<span class="tags-links">
				<?php printf( __( 'Tagged %1$s', 'starter' ), $tags_list ); ?>
			</span>
		...
		<span class="sep"> | </span>
		<span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', 'starter' ), __( '1 Comment', 'starter' ), __( '% Comments', 'starter' ) ); ?></span>
		<?php endif; ?>
