...
?>
	...
	<?php if ( have_comments() ) : ?>
		...
		<nav role="navigation" id="comment-nav-above" class="site-navigation comment-navigation">
			<h1 class="assistive-text"><?php _e( 'Comment navigation', 'starter' ); ?></h1>
		...
		<ol class="commentlist">
			<?php
				 ...
				 * to use starter_comment() to format the comments.
				 * If you want to overload this in a child theme then you can
				 * define starter_comment() and that will be used instead.
				 * See starter_comment() in inc/template-tags.php for more.
				 */
				wp_list_comments( array( 'callback' => 'starter_comment' ) );
			?>
		</ol><!-- .commentlist -->
