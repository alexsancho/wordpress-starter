# Description
description "This is a basic WordPress theme configured to use Twitter Bootstrap with Sass"
...
file 'images/glyphicons-halflings-white.png'
file 'images/glyphicons-halflings.png'

file 'javascripts/app.js'
file 'javascripts/bootstrap.js'
...
help %Q{
    compass create -r wordpress-bootstrap --using wordpress/bootstrap -s compressed bootstrap
}

# Compass Extension Welcome Message
# Users will see this when they create a new project using this template.
welcome_message %Q{
    This is a basic WordPress theme configured to use Twitter Boostrap with Sass
}
